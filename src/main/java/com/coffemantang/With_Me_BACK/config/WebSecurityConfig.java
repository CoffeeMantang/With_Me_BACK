package com.coffemantang.With_Me_BACK.config;

import com.coffemantang.With_Me_BACK.security.JwtAuthenticationFilter;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.cors() //WebMvcConfig에서 이미 설정 했으므로 기본 cors 설정
                ...
                .antMatchers("/", "/partners/member/**", "/non-member/**",
                         "/withMeImgs/**", "/error").permitAll().anyRequest() // 인증 안해도 되는 경로 설정
